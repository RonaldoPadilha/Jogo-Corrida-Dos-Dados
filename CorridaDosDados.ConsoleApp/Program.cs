...
class Program
{
    // definição de um método chamado ExecutarRodadaDoJogador
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            while (true)
            {
                ...
                posicaoJogador = ExecutarRodadaDoJogador(posicaoJogador, limiteLinhaChegada, bonusAvancoExtra, penalidadeRecuo);
